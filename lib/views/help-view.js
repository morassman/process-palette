...
export default class HelpView extends View {
      ...
      <div className="content">
        ...
        <ul>
          <li>
            ...
            <button className="btn btn-sm inline-block-tight" ref="globalButton" on={{ click: this.createGlobalConfigurationFile }}>Do it!</button>
          </li>
          <li>
            <span>The root of any of your project folders for project specific commands </span>
            <button className="btn btn-sm inline-block-tight" ref="projectButton" on={{ click: this.createProjectConfigurationFile }}>Do it!</button>
          </li>
        </ul>
  ...
  initialize() {
    this.globalButton.on('mousedown', e => e.preventDefault());
    return this.projectButton.on('mousedown', e => e.preventDefault());
  }
