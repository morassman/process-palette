  ...
  render() {
    return <div className="process-palette-search-addon" attributes={this.getAttributes()}>
      <div className="process-palette-search-addon-input">
        <input ref="searchInput" class='input-text native-key-bindings' type='text' placeholder='Find' on={{ input: () => this.find(), keydown: (e) => this.onKeyDown(e), keyup: (e) => this.onKeyUp(e) }}></input>
