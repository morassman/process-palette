...
class PanelOutputView extends OutputView {
  ...
  render() {
    ...
    return <div ref="outputPanel" className="process-palette-process-output-view-panel native-key-bindings" attributes={outputPanelAttributes} tabindex={1}
