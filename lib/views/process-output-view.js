    ...
    return <div className="process-palette-process-output-view">
      <div className="process-palette-process-view">
        <div className="process-palette-process-view-toolbar">
          ...
          <span ref="commandName" className="process-palette-process-view-command-name inline-block text-highlight">{_.humanizeEventName(this.processController.config.getCommandName())}</span>
          {this.processController.config.keystroke &&
            <span ref="keystroke" className="process-palette-process-view-keystroke inline-block highlight">
              {_.humanizeKeystroke(this.processController.config.keystroke)}
            </span>}
          <span className="btn-group" attributes={{ style: "margin-right: 1em" }}>
