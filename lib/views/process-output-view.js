...
export default class ProcessOutputView extends View {
  ...
  render() {
    ...
    return <div className="process-output-view">
      <div ref="header" className="process-list-item">
        <div className="process-toolbar">
          ...
          <button ref="runButton" className="btn btn-sm btn-fw icon-playback-play inline-block-tigh" on={{ click: this.runButtonPressed, mousedown: e => e.preventDefault() }} />
          <span ref="commandName" className="header inline-block text-highlight">{_.humanizeEventName(this.processController.config.getCommandName())}</span>
  ...
  outputChanged() {
    ...
    if (this.scrollLocked) {
      ...
      // TODO
      // this.refs.outputPanel.scrollTop(this.refs.outputPanel.get(0).scrollHeight);
    }
  ...
  appendLine(line) {
    ...
    for (let pattern of this.patterns) {
      ...
      if (match != null) {
        ...
        // this.refs.outputPanel.append($$(function() {
        //   return this.span(() => {
