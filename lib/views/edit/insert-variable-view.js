...
export default function showInsertVariableView(editor, showOutputVariables = false, addBraces = true) {
  const items = getItems(showOutputVariables)
  const view = new InsertVariableView(editor, addBraces, items)
  view.open()
}
