...
const showInsertVariableView = require('./insert-variable-view');
...
export default class CommandEditView extends View {
  ...
  insertVariableButton(ref, showOutputVariables = false, addBraces = true) {
    this.tabindex++
    return <button className="btn btn-sm" attributes={{ tabindex: this.tabindex }} on={{ click: () => this.insertVariable(ref, showOutputVariables, addBraces) }}>Insert Variable</button>
  }
  ...
  initialize() {
    ...
    this.refs.successOutputEditor.element.classList.add('multi-line-editor')
    this.refs.errorOutputEditor.element.classList.add('multi-line-editor')
    this.refs.startMessageEditor.element.classList.add('multi-line-editor')
    this.refs.successMessageEditor.element.classList.add('multi-line-editor')
    this.refs.errorMessageEditor.element.classList.add('multi-line-editor')
    this.refs.startScriptEditor.element.classList.add('multi-line-editor')
    this.refs.successScriptEditor.element.classList.add('multi-line-editor')
    this.refs.errorScriptEditor.element.classList.add('multi-line-editor')
    this.refs.stdinEditor.element.classList.add('multi-line-editor');
  ...
  insertVariable(ref, showOutputVariables = false, addBraces = true) {
    showInsertVariableView(this.refs[ref], showOutputVariables, addBraces)
  }
