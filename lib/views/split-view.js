...
class Container extends View {
  ...
  render() {
    return <div className={this.side} attributes={this.getAttributes()} />
  }
}
...
export default class SplitView extends View {
  ...
  render() {
    return <div className="split-view">
      ...
      <div className="divider" on={{ mousedown: e => this.resizeStarted(e) }} />
  ...
  attached() {
    ...
    // $(window).on('resize', this.refreshPosition);
  }

  detached() {
    console.log('detached')
    // TODO
    // $(window).off('resize', this.refreshPosition);
  }
  ...
  setPosition(position) {
    ...
    // if (this.leftView) {
    //   this.leftView.style.set('width', '100%')
    // }

    // if (this.rightView) {
    //   this.rightView.style.set('width', '100%')
    // }
