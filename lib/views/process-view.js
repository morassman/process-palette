...
export default class ProcessView extends View {
  ...
  render() {
    ...
    return <div className="process-palette-process-view" attributes={this.getAttributes()}>
      <div className="process-palette-process-view-toolbar">
        ...
        {this.configController.config.keystroke && <span className="process-palette-process-view-keystroke inline-block highlight">{_.humanizeKeystroke(this.configController.config.keystroke)}</span>}
        <ButtonsView ref="buttonsView" configController={this.configController} />
      </div>
      <table>
        <tbody>
          <tr ref="commandRow">
            <td className="process-palette-process-view-table-title">Command</td>
            <td>
              <div attributes={{ style: "display: flex; align-items: center" }}>
                ...
                <button className="btn btn-xs process-palette-process-view-insert-button" on={{ click: this.insertVariable }}>Insert Variable</button>
              </div>
            </td>
          </tr>
          <tr ref="outputRow">
