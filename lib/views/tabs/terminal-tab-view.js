...
class TerminalTabContentView extends View {
  ...
  insertVariable() {
    const vars = ['fileExt', 'fileName', 'fileNameExt', 'filePath', 'fileDirPath', 'fileAbsPath', 'fileDirAbsPath', 'fileProjectPath', 'text', 'clipboard', 'selection', 'word', 'token', 'line', 'lineNo', 'projectPath']
