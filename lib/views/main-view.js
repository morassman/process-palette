...
class OutputViewContainer extends View {
  ...
  render() {
    return <div className="process-palette-main-content-output-view-container" attributes={this.getAttributes()} />
  }
...
export default class MainView extends View {
  ...
  render() {
    return <div className="process-palette">
      <div className="process-palette-button-group">
  ...
  killFocusedProcess(discard) {
    if (!this.outputViewContainer.isHidden()) {
      if (this.outputView) {
        this.outputView.processController.killProcess(discard)
      }
    }
  }
  ...
  discardFocusedOutput() {
    if (!this.outputViewContainer.isHidden()) {
      if (this.outputView) {
        this.outputView.processController.discard()
      }
    }
  }
