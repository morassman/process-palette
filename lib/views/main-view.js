...
class ListView extends View {
  ...
  render() {
    return <div className="project-list" attributes={this.getAttributes()} ref="listView">ListView</div>
  }
  ...
  render() {
    return <div className="process-palette">
      ...
      <div className="main-content">
        <div className="helpView" ref="helpView"><HelpView ref="hv" main={this.main} /></div>
